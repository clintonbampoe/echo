...
public class TransactionCategorysController(TransactionCategoryService service) : ApiBaseController
{
    [HttpGet]
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] TransactionCategoryUpdateDto dto, CancellationToken ct)
    {
