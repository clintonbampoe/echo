...
public class AttendanceContextsController(AttendanceContextService service) : ApiBaseController
{
    [HttpGet]
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] AttendanceContextCreateDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] AttendanceContextUpdateDto dto, CancellationToken ct)
    {
