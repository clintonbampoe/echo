...
public class ProjectCategorysController(ProjectCategoryService service) : ApiBaseController
{
    [HttpGet]
    ...
    [HttpPost]
    public async Task<IActionResult> Create([FromBody] ProjectCategoryCreateDto dto, CancellationToken ct)
    {
    ...
    [HttpPut("{id:int}")]
    public async Task<IActionResult> Update(int id, [FromBody] ProjectCategoryUpdateDto dto, CancellationToken ct)
    {
