...
public partial class AssetMapper : IAssetMapper
{
    ...
    [MapProperty([nameof(Asset.Category), nameof(entity.Category.Name)], nameof(AssetResponseDto.CategoryName))]
    ...
    public void Patch(AssetUpdateDto dto, Asset entity)
    {
        ...
        if (dto.CurrentValue.HasValue) entity.CurrentValue = dto.CurrentValue.Value;
