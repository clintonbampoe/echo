...
contains overview of system architecture choices and the key non-functional constraints. Also includes information of the tech stack chosen for the project and the rationale and reasoning behind those choices.

---

## 06-data-and-database-modeling/
